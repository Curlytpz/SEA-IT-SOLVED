...
export default function InstructorQuizAttempts(){
  ...
  return <DashboardLayout>
    ...
    {!data?!error&&<LoadingState text="Loading quiz attempts…"/>:<>
      <h1 className="text-2xl font-bold"><GeneratedContent markdown={data.quiz.title} quizText inline/></h1><p className="mt-2 text-sm text-slate-500">{data.attempts.length} attempts · {data.attempts.reduce((sum,a)=>sum+a.pending,0)} responses awaiting review</p>
