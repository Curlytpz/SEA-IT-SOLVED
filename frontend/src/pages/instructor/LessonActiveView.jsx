...
import { Camera, Check, Lightbulb, Mic, Pause, Pencil, Play, Square } from '../../components/icons';
  ...
  return (
    <DashboardLayout>
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
        <BackButton onClick={leaveSession} className="mb-0">Back to Section</BackButton>
        ...
        <Card className="mb-6 p-5 sm:p-6">
          <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
            <div className="min-w-0">
              ...
              <h1 className="text-xl font-bold text-foreground dark:text-foreground sm:text-2xl"><GeneratedContent markdown={lesson?.title} inline/></h1>
              <p className="mt-1 text-sm font-medium text-muted-foreground dark:text-muted-foreground">{lesson?.subjectCode} — {lesson?.subjectName} <span className="mx-1.5 text-slate-300 dark:text-muted-foreground">•</span> {lesson?.sectionName}</p>
