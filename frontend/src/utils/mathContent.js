...
export const normalizeRecognitionNumericArtifacts = mathContentApi.normalizeRecognitionNumericArtifacts;
export const normalizeRecognitionLatex = mathContentApi.normalizeRecognitionLatex;
